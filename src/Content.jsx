  ...
  return <div className="content-wrapper">
      <Paper id='content-paper' style={{ width: '97%',  marginTop: '-30px' }} elevation="15">
        <div className='content-header'>
          ...
          <Typography variant='h6' style={{color: '#3C4858', paddingTop: '20px'}}>I've always had a passion for technology. Apart from my technical skills, here are some of the things I think I do well.</Typography>
        </div>
        <div className='skills-wrapper'>
          ...
          <SkillCard icon='access_time' header='Time Keeping' text="I value the company and the client's time, and am always aiming to improve and optimize my workflow to be as efficent and effective with my time as possible."/>
